public class BirthdayTest extends TestSuite {
        ...
        public Test[] getTests() {
                return new Test[] { new Test("A bad people argument",
                                () -> expectThrows(() -> SharedBirthday.probabilityEstimate(1, 2, 1),
                                                IllegalArgumentException.class, "At least two people required")),
                                new Test("A bad day argument",
                                                () -> expectThrows(() -> SharedBirthday.probabilityEstimate(5, 0, 2),
                                                                IllegalArgumentException.class,
                                                                "At least one day required")),
                                new Test("A bad trial argument",
                                                () -> expectThrows(() -> SharedBirthday.probabilityEstimate(2, 2, -3),
                                                                IllegalArgumentException.class,
                                                                "At least one trial required")),
                                new Test("2 people and 3 days",
                                                () -> expectWithin(SharedBirthday.probabilityEstimate(2, 3, 100000),
                                                                1.0 / 3, 0.01)),
                                new Test("2 people and 4 days",
                                                () -> expectWithin(SharedBirthday.probabilityEstimate(2, 4, 100000),
                                                                0.250000, 0.01)),
                                new Test("20 people and 400 days",
                                                () -> expectWithin(SharedBirthday.probabilityEstimate(20, 400, 100000),
                                                                0.383016, 0.01)),
                                new Test("10 people and 20 days",
                                                () -> expectWithin(SharedBirthday.probabilityEstimate(10, 20, 1000000),
                                                                0.934527, 0.005)),
                                new Test("200 people and 365 days",
                                                () -> expectWithin(SharedBirthday.probabilityEstimate(200, 365, 10000),
                                                                1.0, 0.001)),
                                new Test("Having no command line arguments",
                                                () -> expectStandardErrorToHave(
